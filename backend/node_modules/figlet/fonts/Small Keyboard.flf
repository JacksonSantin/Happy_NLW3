...
Adapted for figlet by Kent Nassen, [removido], 11/22/94, based
on the idea:

From: [removido] (Bas Meijer)
...
Sender: [removido]
Approved: [removido]
Message-ID: <3asrhi$[removido]>
References: <3asltp$[removido]>
Reply-To: [removido]
NNTP-Posting-Host: gagme.wwa.com


In article [removido], [removido] (SuperStreetFighter2Turbo) writes:
> 
...
email: [removido]     ____  ____      KTH, Dept. of Mach. Design
