...
**isStream** is Copyright (c) 2015 Rod Vagg [@rvagg]([removido]) and licenced under the MIT licence. All rights not explicitly granted in the MIT license are reserved. See the included LICENSE.md file for more details.
